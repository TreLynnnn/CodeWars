...
// Parameters: takes in an array of ones and zeros, varies in length
...
// Psuedocode: 
// Take array and join elements together into a string and then convert to binary using that string. Return the integer equivalent
